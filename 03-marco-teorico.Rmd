...
Se apoya en representar cadenas de texto de un documento como vectores *embeddings* que son almacenados en una base de dato y dado un *query* se transforma el texto en otro *embedding* y se determina cuáles son los embeddings de la base de dato que presentan mayor similitud [@muennighoff2022a].
