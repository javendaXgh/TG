...
\item
  Obtener 375 nombres de postgrado y 50 de carreras de pregrado, generando 454 etiquetas en total que servirán de insumo necesario para alcanzar lo propuesto en el Objetivo Específico 2.
\item
...
{\centering \includegraphics[width=0.9\linewidth]{images/05-desarrollo/4_ciclo/diagrama_entidadrel_SCSU} 
...
\item
  ...
  \end{figure}
\item
  \textbf{Validación manual:} Se procede con la muestra a validar manualmente si la clasificación efectuada el nombre del tutor extraído se corresponde con el que aparece en el documento escrito.
\item
...
\item
  ...
  \item
    Usar los corpus que se obtengan para realizar el sobre entrenamiento (\emph{fine tunning}) de ``Largos Modelos de Lenguaje'' y así lograr que estos sean adaptados a las necesidades de dominios específicos de conocimiento de una determinada comunidad de investigadores.
  \item
    Mejorar la representación de los ``Mapas de Conocimiento'' mediante representaciones más elaboradas de los conceptos que son abordados en las investigaciones que conforman el corpus.
  \item
    Evaluar distintos modelos de aprendizaje automático para realizar el \emph{rerank} a los resultados obtenidos en un \emph{query}.
  \item
